...
var ReactCompositeComponentMixin = {
  ...
  /**
   * Lazily allocates the 26.refs object and stores `component` as `ref`.
   *
 ...
 *       this.26.refs.custom.handleClick();
 *     },
 *     componentDidMount: function() {
 *       this.26.refs.custom.initialize();
 *     }
 *   });
 *
 * Refs should rarely be used. When 26.refs are used, they should only be done to
...
var ReactOwner = {
  ...
  addComponentAsRefTo: function (component, ref, owner) {
    !ReactOwner.isValidOwner(owner) ? "development" !== 'production' ? invariant(false, 'addComponentAsRefTo(...): Only a ReactOwner can have 26.refs. You might ' + 'be adding a ref to a component that was not created inside a component\'s ' + '`render` method, or you have multiple copies of React loaded ' + '(details: https://fb.me/react-refs-must-have-owner).') : invariant(false) : undefined;
...
ReactRef.shouldUpdateRefs = function (prevElement, nextElement) {
  ...
  // if you swap the keys of but not the 26.refs. Reconsider where this check
